    ...
    def create_tables(self):
        ...
        create_table_query_for_category = ( 
                                    ...
                                    category(
                                                ...
                                                admin (admin_id) ON DELETE CASCADE ON UPDATE CASCADE
                                            );"""
                                    )
        ...
        create_table_query_for_store_attendants = (
                                                   """CREATE TABLE IF NOT EXISTS
                                                   store_attendant(
        ...
        self.cursor.execute(create_table_query_for_admin)
        self.cursor.execute(create_table_query_for_category)
        self.cursor.execute(create_table_query_for_products)
        self.cursor.execute(create_table_query_for_store_attendants)
